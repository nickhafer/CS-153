...
"""
        ...
        for attempt in range(2):
            ...
            summarize_prompt += f"\n\nYour previous response did not clearly include all {num_results} results. Please list EACH result separately with a number (1., 2., etc.) and include ALL {num_results} results. Add a nature emoji (🌲, 🏞️, etc.) before each numbered result."
