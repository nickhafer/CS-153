...
"""
        ...
        for attempt in range(2):
            ...
            if (has_numbered_list or has_bullet_points) and num_results > 1:
                ...
                if supplementary_results and "supplementing with AI" not in response_text.lower() and "not found in the" not in response_text.lower():
            ...
            if num_results == 1 or attempt == 1:
                if num_results > 1:
                    ...
                    if supplementary_results and "supplementing with AI" not in response_text.lower() and "not found in the" not in response_text.lower():
                        ...
                        # Check if there's already a divider in the text to avoid duplication
